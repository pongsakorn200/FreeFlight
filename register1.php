...
if(isset($_POST)){
    ...
    $sql = "INSERT INTO customers(databaseType, title, Fname, Lname, tel, email, username, password, PersonalID) VALUES('" .$databaseType. "','" .$title. "','" .$Fname."','".$Lname."','" .$tel."','" .$email."','".$username."','".$password."','".$PersonalID."')";
