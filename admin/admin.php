...
<?php
try {
$pdo = new PDO("mysql:host=localhost;dbname=ff;charset=utf8", "root", "");
		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-4">
							<div id="colorlib-logo"><a href="admin.html">FREE FLIGHT ADMIN</a></div>
                        </div>
						<div class="col-xs-8 text-right menu-1" style="text-align: right;">
                                <ul>
                                    <li><a href="promotion.html">Logout</a></li>
                                </ul>
                            </div>
					</div>
				</div>
        ...
        <div class="w3-container">
            <label></label>
                ...
                <label></label>
                  <h2>เที่ยวบิน</h2>
                  <?php   
                $stmt = $pdo->prepare("SELECT flightID,AirPortID,flightTime,Price,AirlineID
                                        FROM flight
                                        ORDER BY flightID");
                $stmt->execute();
                ?>
                        <table class="table table-borderless table-hover" >
                            <thead class="table-success">
                                <tr>
                                    ...
                                    <th scope="col">หมายเลขสนามบิน</th>
